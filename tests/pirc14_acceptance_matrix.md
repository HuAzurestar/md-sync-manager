...
| AT-004 | REQ-002, REQ-005 | API | Initial pull returns a diff summary and confirmation token without changing content; valid confirmation applies it, while cancel/expired/mismatched confirmation performs zero writes | DEV-03, DEV-07 |
| AT-005 | REQ-003 | browser | One ordinary Markdown file can be opened, edited, previewed, cataloged, multi-read, single-section-applied, and synced; no review control exists | DEV-06 |
