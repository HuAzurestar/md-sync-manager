...
1. Open or drag a `.md` file. The single work area opens in **Markdown source** mode.
...
6. Download starts a browser download of the edited copy, while Upload/New creates a remote object. Pull, push, and upload do not write back to a file previously opened from disk. The badge keeps changes marked as not saved locally; download an updated copy and reopen it to establish a new local baseline.
